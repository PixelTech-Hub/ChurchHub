...
var UI;
(function(UI2) {
  UI2["ButtonPrevious"] = "button_previous";
  UI2["ButtonNext"] = "button_next";
  UI2["Root"] = "root";
  UI2["Chevron"] = "chevron";
  UI2["Day"] = "day";
...
function Chevron(props) {
  ...
  return import_react2.default.createElement(
    ...
    orientation === "right" && import_react2.default.createElement("polygon", { points: "8 18.612 14.1888889 12.5 8 6.37733333 9.91111111 4.5 18 12.5 9.91111111 20.5" })
  );
}
...
function Nav(props) {
  return import_react13.default.createElement("nav", { ...props });
}

// node_modules/react-day-picker/dist/esm/components/Option.js
var import_react14 = __toESM(require_react(), 1);
function Option(props) {
  return import_react14.default.createElement("option", { ...props });
}
...
function Select(props) {
  return import_react16.default.createElement("select", { ...props });
}

// node_modules/react-day-picker/dist/esm/components/Weeks.js
var import_react17 = __toESM(require_react(), 1);
function Weeks(props) {
  return import_react17.default.createElement("tbody", { ...props });
}
...
function Week(props) {
  ...
  return import_react18.default.createElement("tr", { ...trProps });
}

// node_modules/react-day-picker/dist/esm/components/Weekday.js
var import_react19 = __toESM(require_react(), 1);
function Weekday(props) {
  return import_react19.default.createElement("th", { ...props });
}
...
function Weekdays(props) {
  return import_react20.default.createElement(
    "thead",
    null,
    import_react20.default.createElement("tr", { ...props })
  );
}
...
function labelNext(month, options) {
  return "Go to the Next Month";
}

// node_modules/react-day-picker/dist/esm/labels/labelPrevious.js
function labelPrevious(month, options) {
...
function useControlledValue(defaultValue, controlledValue) {
  const [uncontrolledValue, setValue] = (0, import_react23.useState)(defaultValue);
...
function useCalendar(props, dateLib2) {
  ...
  const initialDisplayMonth = getInitialMonth(props, dateLib2);
  const [firstMonth, setFirstMonth] = useControlledValue(initialDisplayMonth, props.month ? startOfMonth2(props.month) : void 0);
...
var dayPickerContext = (0, import_react24.createContext)(void 0);
function useDayPicker(props) {
  const context = (0, import_react24.useContext)(dayPickerContext);
  if (context === void 0) {
...
function dateMatchModifiers(date, matchers, dateLib2) {
...
function useFocus(props, calendar, getModifiers, isSelected, dateLib2) {
  ...
  const [lastFocused, setLastFocused] = (0, import_react25.useState)();
  const focusTarget = calculateFocusTarget(calendar.days, getModifiers, isSelected || (() => false), lastFocused);
  const [focusedDay, setFocused] = (0, import_react25.useState)(autoFocus ? focusTarget : void 0);
  const blur = () => {
  ...
  for (const day of days) {
    ...
    if (modifiers) {
      Object.keys(modifiers).forEach((name) => {
        ...
        const isMatch = modifierValue ? dateMatchModifiers(date, modifierValue, dateLib2) : false;
        if (!isMatch)
          return;
        if (custom[name]) {
...
function useMulti(props, dateLib2) {
  ...
  const [selected, setSelected] = import_react26.default.useState(initiallySelected);
  const { isSameDay: isSameDay2, Date: Date2 } = dateLib2;
  import_react26.default.useEffect(() => {
    if (required && selected === void 0) {
      setSelected([new Date2()]);
    }
  }, [required, selected, Date2, mode]);
  import_react26.default.useEffect(() => {
...
function addToRange(date, range, dateLib2 = dateLib) {
  const { from, to } = range || {};
  const { isSameDay: isSameDay2, isAfter: isAfter2, isBefore: isBefore2 } = dateLib2;
  if (from && to) {
    if (isSameDay2(to, date) && isSameDay2(from, date)) {
      return { from: void 0, to: void 0 };
    }
    if (isSameDay2(to, date)) {
      return { from: to, to: void 0 };
    }
    if (isSameDay2(from, date)) {
      return { from: void 0, to: void 0 };
    }
    if (isAfter2(from, date)) {
      return { from: date, to };
    }
    return { from, to: date };
  }
  ...
  if (from) {
    if (isBefore2(date, from)) {
      return { from: date, to: from };
    }
    if (isSameDay2(date, from)) {
      return { from: void 0, to: void 0 };
    }
    return { from, to: date };
  }
  return { from: date, to: void 0 };
}

// node_modules/react-day-picker/dist/esm/selection/useRange.js
function useRange(props, dateLib2) {
  const { mode, disabled, excludeDisabled, selected: initiallySelected, required, onSelect } = props;
  const { differenceInCalendarDays: differenceInCalendarDays2 } = dateLib2;
  const [selected, setSelected] = import_react27.default.useState(initiallySelected);
  import_react27.default.useEffect(() => {
    if (required && selected === void 0) {
      setSelected({ from: void 0, to: void 0 });
    }
  ...
  const select = (triggerDate, modifiers, e) => {
    const newRange = triggerDate ? addToRange(triggerDate, selected, dateLib2) : void 0;
    const { min: min2, max: max2 } = props;
    if (min2) {
      if ((newRange == null ? void 0 : newRange.from) && newRange.to && differenceInCalendarDays2(newRange.to, newRange.from) < min2 - 1) {
        newRange.from = triggerDate;
        newRange.to = void 0;
      }
    }
    if (max2) {
      if ((newRange == null ? void 0 : newRange.from) && newRange.to && differenceInCalendarDays2(newRange.to, newRange.from) >= max2) {
        newRange.from = triggerDate;
        newRange.to = void 0;
      }
    }
...
function useSingle(props, dateLib2) {
  const { selected: initiallySelected, required, onSelect, mode } = props;
  const [selected, setSelected] = import_react28.default.useState(initiallySelected);
  const { isSameDay: isSameDay2, Date: Date2, startOfDay: startOfDay2 } = dateLib2;
  import_react28.default.useEffect(() => {
    if (required && selected === void 0) {
      setSelected(startOfDay2(new Date2()));
    }
  }, [required, selected, Date2, startOfDay2, mode]);
  import_react28.default.useEffect(() => {
    setSelected(initiallySelected);
  }, [initiallySelected]);
...
function DayPicker(props) {
  const { components, formatters: formatters2, labels, dateLib: dateLib2, classNames } = (0, import_react29.useMemo)(() => ({
  ...
  const weekdays = (0, import_react29.useMemo)(() => getWeekdays(locale, props.weekStartsOn, props.ISOWeek, dateLib2), [dateLib2, locale, props.ISOWeek, props.weekStartsOn]);
  const isInteractive = mode !== void 0 || onDayClick !== void 0;
  const handlePreviousClick = (0, import_react29.useCallback)(() => {
    if (!previousMonth)
      return;
    goToMonth(previousMonth);
    onPrevClick == null ? void 0 : onPrevClick(previousMonth);
  }, [previousMonth, goToMonth, onPrevClick]);
  const handleNextClick = (0, import_react29.useCallback)(() => {
    if (!nextMonth)
      return;
    goToMonth(nextMonth);
    onNextClick == null ? void 0 : onNextClick(nextMonth);
  }, [goToMonth, nextMonth, onNextClick]);
  const handleDayClick = (0, import_react29.useCallback)((day, m) => (e) => {
    e.preventDefault();
    e.stopPropagation();
    setFocused(day);
  ...
  const handleDayFocus = (0, import_react29.useCallback)((day, m) => (e) => {
    setFocused(day);
    onDayFocus == null ? void 0 : onDayFocus(day.date, m, e);
  }, [onDayFocus, setFocused]);
  const handleDayBlur = (0, import_react29.useCallback)((day, m) => (e) => {
    blur();
    onDayBlur == null ? void 0 : onDayBlur(day.date, m, e);
  }, [blur, onDayBlur]);
  const handleDayKeyDown = (0, import_react29.useCallback)((day, modifiers) => (e) => {
    const keyMap = {
  ...
  const handleDayMouseEnter = (0, import_react29.useCallback)((day, modifiers) => (e) => {
    onDayMouseEnter == null ? void 0 : onDayMouseEnter(day.date, modifiers, e);
  }, [onDayMouseEnter]);
  const handleDayMouseLeave = (0, import_react29.useCallback)((day, modifiers) => (e) => {
    onDayMouseLeave == null ? void 0 : onDayMouseLeave(day.date, modifiers, e);
  }, [onDayMouseLeave]);
  const { className, style } = (0, import_react29.useMemo)(() => ({
  ...
  return import_react29.default.createElement(
    ...
    import_react29.default.createElement(
      ...
      import_react29.default.createElement(
        ...
        !props.hideNavigation && import_react29.default.createElement(
          components.Nav,
          { role: "navigation", className: classNames[UI.Nav], style: styles == null ? void 0 : styles[UI.Nav], "aria-label": labelNav2() },
          import_react29.default.createElement(
            components.Button,
            { type: "button", className: classNames[UI.ButtonPrevious], tabIndex: previousMonth ? void 0 : -1, disabled: previousMonth ? void 0 : true, "aria-label": labelPrevious2(previousMonth, labelOptions), onClick: handlePreviousClick },
            import_react29.default.createElement(components.Chevron, { disabled: previousMonth ? void 0 : true, className: classNames[UI.Chevron], orientation: "left" })
          ),
          import_react29.default.createElement(
            components.Button,
            { type: "button", className: classNames[UI.ButtonNext], tabIndex: nextMonth ? void 0 : -1, disabled: nextMonth ? void 0 : true, "aria-label": labelNext2(nextMonth, labelOptions), onClick: handleNextClick },
            import_react29.default.createElement(components.Chevron, { disabled: previousMonth ? void 0 : true, orientation: "right", className: classNames[UI.Chevron] })
          )
        ),
        months.map((calendarMonth, displayIndex) => {
          ...
          return import_react29.default.createElement(
            ...
            import_react29.default.createElement(components.MonthCaption, { className: classNames[UI.MonthCaption], style: styles == null ? void 0 : styles[UI.MonthCaption], calendarMonth, displayIndex }, (captionLayout == null ? void 0 : captionLayout.startsWith("dropdown")) ? import_react29.default.createElement(
              components.DropdownNav,
              { className: classNames[UI.Dropdowns], style: styles == null ? void 0 : styles[UI.Dropdowns] },
              captionLayout === "dropdown" || captionLayout === "dropdown-months" ? import_react29.default.createElement(components.Dropdown, { "aria-label": labelMonthDropdown2(), classNames, components, disabled: Boolean(props.disableNavigation), onChange: handleMonthChange, options: dropdownMonths, style: styles == null ? void 0 : styles[UI.Dropdown], value: calendarMonth.date.getMonth() }) : import_react29.default.createElement("span", { role: "status", "aria-live": "polite" }, formatMonthDropdown2(calendarMonth.date.getMonth())),
              captionLayout === "dropdown" || captionLayout === "dropdown-years" ? import_react29.default.createElement(components.Dropdown, { "aria-label": labelYearDropdown2(labelOptions), classNames, components, disabled: Boolean(props.disableNavigation), onChange: handleYearChange, options: dropdownYears, style: styles == null ? void 0 : styles[UI.Dropdown], value: calendarMonth.date.getFullYear() }) : import_react29.default.createElement("span", { role: "status", "aria-live": "polite" }, formatYearDropdown2(calendarMonth.date.getFullYear()))
            ) : import_react29.default.createElement(components.CaptionLabel, { className: classNames[UI.CaptionLabel], role: "status", "aria-live": "polite" }, formatCaption2(calendarMonth.date, formatOptions, dateLib2))),
            import_react29.default.createElement(
              ...
              !props.hideWeekdays && import_react29.default.createElement(
                components.Weekdays,
                { className: classNames[UI.Weekdays], role: "row", style: styles == null ? void 0 : styles[UI.Weekdays] },
                showWeekNumber && import_react29.default.createElement(components.WeekNumberHeader, { "aria-label": labelWeekNumberHeader2(labelOptions), className: classNames[UI.WeekNumberHeader], role: "columnheader", style: styles == null ? void 0 : styles[UI.WeekNumberHeader] }, formatWeekNumberHeader2()),
                weekdays.map((weekday, i) => import_react29.default.createElement(components.Weekday, { "aria-label": labelWeekday2(weekday, labelOptions, dateLib2), className: classNames[UI.Weekday], key: i, role: "columnheader", style: styles == null ? void 0 : styles[UI.Weekday] }, formatWeekdayName2(weekday, formatOptions, dateLib2)))
              ),
              import_react29.default.createElement(components.Weeks, { className: classNames[UI.Weeks], role: "rowgroup", style: styles == null ? void 0 : styles[UI.Weeks] }, calendarMonth.weeks.map((week, weekIndex) => {
                return import_react29.default.createElement(
                  components.Week,
                  { className: classNames[UI.Week], key: week.weekNumber, role: "row", style: styles == null ? void 0 : styles[UI.Week], week },
                  showWeekNumber && import_react29.default.createElement(components.WeekNumber, { week, role: "rowheader", style: styles == null ? void 0 : styles[UI.WeekNumber], "aria-label": labelWeekNumber2(week.weekNumber, {
                    locale
      ...
      props.footer && import_react29.default.createElement(components.Footer, { className: classNames[UI.Footer], style: styles == null ? void 0 : styles[UI.Footer], role: "status", "aria-live": "polite" }, props.footer)
    )
  );
}
