...
import { getAllChurches, getSingleChurch } from "../../features/churches/churchSlice";
...
const GeneralInfoCard: FC<GeneralInfoCardProps> = function ({ staff, onUpdate }) {
    ...
    const { singleChurch } = useAppSelector(state => state.church);
    ...
    useEffect(() => {
        if (staff) {
            ...
            if (staff.churchId) {
                dispatch(getSingleChurch(staff.churchId));
            }
        }
    }, [staff, dispatch]);
