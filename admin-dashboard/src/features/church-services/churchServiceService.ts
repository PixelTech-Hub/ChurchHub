import { ALL_CHURCH_SERVICE_API_URL, CHURCH_SERVICE_API_URL } from "../../app/api";
import { ChurchServices } from "../../types/ChurchServices";

const postNewChurchService = async (serviceData: ChurchServices) => {
	try {
		...
		console.error("Post Church Service Error:", error);
		throw error;
	}
};
