...
export const Pagination: FC = function () {
  return (
    <div className="mx-2 mt-2 sticky bottom-0 right-0 items-center border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:flex sm:justify-between">
