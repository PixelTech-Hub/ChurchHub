...
import PasswordInformationCard from "../../components/settings/PasswordInformationCard";
import GeneralInformationCard from "../../components/settings/GeneralInformationCard";
        ...
        <div className="grid grid-cols-1 gap-y-6 px-4 pt-6 dark:bg-gray-900 xl:grid-cols-3 xl:gap-4">
          <div className="col-span-full">
            <Breadcrumb className="mb-4">
              ...
              <Breadcrumb.Item href="/users/list">Admin</Breadcrumb.Item>
          ...
          <div className="col-span-2">
            <div className="grid grid-cols-1 gap-y-4">
              <GeneralInformationCard admin={user}/>
            </div>
          </div>
        </div>
      </>
