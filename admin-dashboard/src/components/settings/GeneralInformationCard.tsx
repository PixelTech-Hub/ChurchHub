...
import { updateChurchStaff } from '../../features/auth/authSlice';

interface CardProps {
	admin: Users;
}

type AdminField = keyof Users;

const GeneralInformationCard: React.FC<CardProps> = ({ admin }) => {
	const dispatch = useAppDispatch();
	const [editMode, setEditMode] = useState<AdminField | null>(null);
	const [formData, setFormData] = useState<Users>(admin);
	...
	console.log('Please select me ', admin)
	...
	return (
		<Card>
			...
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
				...
				{renderField('Phone Number', 'contact', 'tel')}
